...
final class GSRN extends Data implements \Stringable, Castable
{
    ...
    public static function createFromString(string $value): self
    {
        ...
        throw new \InvalidArgumentException('Invalid GSRN: '.$value);
    }
    ...
    public static function dataCastUsing(...$arguments): Cast
    {
        return new class() implements Cast
        {
            ...
            {
                return GSRN::createFromString((string) $value);
            }
        };
    }
